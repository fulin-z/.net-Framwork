...
{
    public partial class FormRebuyBill : Form
    {
        ...
        private void FormRebuyBill_Load(object sender, EventArgs e)
        {
            txtBillCode.Text = r_billcode;
            DataSet ds = datacon.getds("select * from tb_BuyStock where BillCode='" + r_billcode + "'", "tb_BuyStock");
            ds.Dispose();
            ...
            DataSet ds2 = datacon.getds("select GoodsCode,GoodsName,Standard,Num,Price,Money from tb_BuyStockDetail where BillCode='" + r_billcode + "'", "tb_BuyStockDetail");
            ds2.Dispose();
