...
namespace EMS.SubForms
{
    public partial class FormResaleBill : Form
    {
        ...
        private void FormResaleBill_Load(object sender, EventArgs e)
        {
            txtBillCode.Text = r_billcode;
            DataSet ds = datacon.getds("select * from tb_SaleStock where BillCode='" + r_billcode + "'", "tb_SaleStock");
            ds.Dispose();
            ...
            DataSet ds2 = datacon.getds("select GoodsCode,GoodsName,Standard,Num,Price,Money from tb_SaleStockDetail where BillCode='" + r_billcode + "'", "tb_SaleStockDetail");
            ds2.Dispose();
